"""
Django settings for green_gardens project.
...
ALLOWED_HOSTS = ['greengardens1.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'green_gardens.urls'
...
AUTHENTICATION_BACKENDS = [
    # Allows superusers to login to admin, regardless of `allauth`
    'django.contrib.auth.backends.ModelBackend',

    # Allows users to login by using their email
...
if 'USE_AWS' in os.environ:
    ...
    AWS_STORAGE_BUCKET_NAME = 'tred-greengardens'
    ...
    # Override the media and static URLs in production
