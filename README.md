...
* Checkout and receive a confirmation email.
* View blog tips and tricks.
...
* the page laid out neatly so that I can find information effortlessly with a search bar allowing me to search for product items by name.
...
* receive a confirmation email once my order is placed to confirm my order has been placed.
* view tips and tricks on a blog page.

### Site owner goals

#### As the site owner, I want - 
* to provide a simple navigation display making it easy for users to navigate through the website with search bar for users to search items by product name.
